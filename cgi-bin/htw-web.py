...
if (option == "s"):
	...
	# Player is in empty room, continue game	
		...
		if int(wumpus) in borders or int(bats) in borders or int(pits) in borders:
		...
		print("</select><br /><br />")
		print("Pick a room: ")
		print("<select name='room' style='color: #404040' multiple='multiple'>")
