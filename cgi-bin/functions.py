import random
#Function to generate a random sequence of caves 
...
# it should be different from the first cave and from where the wumpus is
...
#choose a cave for the pits
# it should be different from the first cave, also cannot be where the wumpus and the bats are!
